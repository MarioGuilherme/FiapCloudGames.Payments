...
public class PaymentService(IUnitOfWork unitOfWork, IPagSeguroService pagSeguroService) : IPaymentService
{
    ...
    public async Task<RestResponse<PaymentViewModel>> CreateAsync(CreatePaymentInputModel inputModel)
    {
