using FiapCloudGames.Payments.API.Filters;
using FiapCloudGames.Payments.API.Middlewares;
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.NewRelicLogs(
        ...
        applicationName: "FiapCloudGames.Payments")
    .CreateLogger();
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new()
    {
        Title = "API - Fiap Cloud Games - Payments",
...
try
{
    ...
    FiapCloudGamesPaymentsDbContext context = services.GetRequiredService<FiapCloudGamesPaymentsDbContext>();
